...
public abstract class Figure implements Serializable {
	...
	public static final DataFormat CHESS_FIGURE = new DataFormat("chess.figure");
	...
	public Figure move(ChessField field, boolean graphic) {
		...
		y = field.getY();
		setField(field);
		Figure postFigure = postTurnAction(ChessGameUI.getBoard().getField(oldX, oldY), field, graphic);
	...
	public boolean canMove() {
		return getField().getBoard().getTurn() == color && ChessGameUI.getPlayer().getColor() == color && ChessGameUI.gameStarted();
	}
